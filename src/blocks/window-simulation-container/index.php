 ...
 */
function vsqd_window_sim_block_block_init() {

	register_block_type(
		__DIR__,
		array(
			'render_callback' => 'vsqd_window_sim_block_render_callback',
		)
	);
}
add_action( 'init', 'vsqd_window_sim_block_block_init' );
 ...
 */
function vsqd_window_sim_block_render_callback( $attributes, $content, $block_instance ) {
	ob_start();
	/**
